        ...
        <div class="col-4">
            ...
            <form action="../actions/edit-user.php" method="POST" enctype="multipart/form-data">
                <div class="row justify-content-center mb-3">
                    ...
                    ?>
                       <i class="fa-solid fa-user text-seccondary d-block text-center edit-icon"></i>
                    <?php
                       }
              ...
              <div class="text-end">
                ...
                <button type="submit" name="edit_user" class="btn btn-warning btn-sm px5">Save</button>
              </div>
            </form>
